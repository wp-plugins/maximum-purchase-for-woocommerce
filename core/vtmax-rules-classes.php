	...
	public function __construct(){
     ...
     $this->inpop =  array (
        array(  
            ...
            'label'  =>  __(' Apply to all Products in the Cart', 'vtmax'), 
        ...
        array(  
            ...
            'label'  => __( ' Use Selection Groups', 'vtmax'), 
            'user_input'  => '' //checked, selected, contents, etc 
        ) ,
         array(  
            'id'    => 'varChoice',
            ...
            'label'  =>  __(' Single Product with Variations', 'vtmax'), 
            'user_input'  => ''  //checked, selected, contents, etc 
        ),
         array(  
            'id'    => 'singleChoice',
            ...
            'label'  =>  __(' Single Product Only', 'vtmax'), 
            'user_input'  => ''  //checked, selected, contents, etc 
        )  
      );
  ...
  //    $this->inpop_group_is_based_on;
      ...
      $this->specChoice_in =  array (   
        array(  
            ...
            'name'    => 'specChoice',  
            'value'  => 'all', 
            'label'  =>  __(' *All* in the Population', 'vtmax'), 
            'user_input'  => ''  //checked, selected, contents, etc 
        ) , 
        array(  
            'id'    => 'eachChoice',
            ...
            'name'    => 'specChoice',  
            'value'  => 'each', 
            'label'  =>  __(' *Each* in the Population', 'vtmax'), 
            'user_input'  => ''  //checked, selected, contents, etc 
        ) ,
        array(  
            'id'    => 'anyChoice',
            ...
            'name'    => 'specChoice',  
            'value'  => 'any', 
            'label'  =>  __(' *Any* in the Population with limits', 'vtmax'), 
            'user_input'  => ''  //checked, selected, contents, etc 
        ) 
      );
     ...
     $this->amtSelected = array  (
        array(  
            ...
            'name'    => 'amtSelected',  
            'value'  => 'quantity', 
            'label'  =>  __(' Apply to Quantity Total', 'vtmax'), 
            'user_input'  => ''  //checked, selected, contents, etc 
        ) ,
        array( 
            'id'    => 'amtSelected',
            ...
            'name'    => 'amtSelected',  
            'value'  => 'currency', 
            'label'  =>  __(' Apply to Price', 'vtmax'), 
            'user_input'  => ''  //checked, selected, contents, etc 
        ) 
      );
     $this->amtSelected_selection; //quantity or currency 
     $this->maximum_amt = array ( 
            'id'    => 'amtChoice-count',
            'class'  => 'text',
            'type'  => 'text',
     ...
     $this->maxRule_typeSelected = array  (    //mwnd
        array(  
            'id'    => 'cartSelected',
        ...
        array( 
            ...
            'name'    => 'maxRule-typeSelected',  
            'value'  => 'lifetime', 
            'label'  =>  __(' Lifetime Purchases', 'vtmax'), 
            'user_input'  => ''  //checked, selected, contents, etc 
        ) 
      );
     ...
     */
     ...
     $this->inpop_found_list = array(
        ...
        array(
          ...
          'purch_hist_product_row_id'  => '',     //mwnd
          'purch_hist_product_price_total'  => '',     //mwnd
          'purch_hist_product_qty_total'  => ''         //mwnd
        )
        */
      ); 
      ...
      $this->purch_hist_rule_row_id;  //mwnd
      $this->purch_hist_rule_row_qty_total = 0.00;  //mwnd
      $this->purch_hist_rule_row_price_total = 0.00;  //mwnd
      
      $this->purch_hist_found_why;
